...
class DatasetPASCALPart(Dataset):
    def __init__(self, datapath, fold, transform, split, shot, box_crop=True, test_num=1000):
        ...
        self.json_file = os.path.join(datapath, 'Pascal-Part/all_obj_part_to_image.json')
        self.img_file = os.path.join(datapath, 'Pascal-Part/JPEGImages/{}.jpg')
        self.anno_file = os.path.join(datapath, 'Pascal-Part/Annotations_Part_json_merged_part_classes/{}.json')
    ...
    def __getitem__(self, idx):
        ...
        query_image, query_cmask, support_images, support_cmasks, query_img_id, support_img_ids, \
    ...
    def sample_episode(self, idx):
        ...
        if self.box_crop:
            ...
            for sup_img, sup_mask, sup_box in zip(support_imgs, support_masks, support_boxes):
                ...
                sup_mask = sup_mask[sup_box[1]:sup_box[3], sup_box[0]:sup_box[2]]
                sup_mask = sup_mask.astype(np.uint8)
                new_support_masks.append(sup_mask)
